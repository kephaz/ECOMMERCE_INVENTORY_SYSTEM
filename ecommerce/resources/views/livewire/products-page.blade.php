                  ...
                  <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                    <div class="border border-gray-300">
                      ...
                      <div class="p-3 ">
                        ...
                        <p class="text-lg ">
                          <span class="text-green-600">$800.00</span>
                        </p>
                      </div>
                      <div class="flex justify-center p-4 border-t border-gray-300">
      
                        <a href="#" class="text-gray-500 flex items-center space-x-2 hover:text-red-500">
                ...
                <div class="flex justify-end mt-6">
                  <nav aria-label="page-navigation">
                    <ul class="flex list-style-none">
                      ...
                      <li class="page-item ">
                        <a href="#" class="relative block px-3 py-1.5 mr-3 text-base hover:text-blue-700 transition-all duration-300 hover:bg-blue-200 rounded-md text-gray-100 bg-blue-400">1
                        </a>
                      </li>
                      <li class="page-item ">
